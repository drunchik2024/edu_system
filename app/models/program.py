...
class EducationalProgram(Base):
    ...
    curriculum_file_full_time: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    curriculum_file_part_time: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    curriculum_file_mixed: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
